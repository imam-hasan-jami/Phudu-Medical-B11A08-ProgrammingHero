        ...
        <div className='max-w-[380px] mx-auto lg:max-w-[1440px] lg:mt-20 lg:mb-20'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-4 gap-2 lg:gap-12'>
                <div className='flex flex-col items-center bg-white px-12 py-10 rounded-2xl'>
                    ...
                    <CountUp className='text-[64px] font-extrabold' start={0} end={199} suffix='+' duration={4} enableScrollSpy={true} scrollSpyDelay={500} />
                    <p className='text-2xl font-semibold'>Total Doctors</p>
                </div>
                <div className='flex flex-col items-center bg-white px-12 py-10 rounded-2xl'>
                    <img className='w-15' src={successPatients} alt="" />
                    <CountUp className='text-[64px] font-extrabold' start={100} end={467} suffix='+' duration={4} enableScrollSpy={true} scrollSpyDelay={500} />
                    <p className='text-2xl font-semibold'>Total Reviews</p>
                </div>
                <div className='flex flex-col items-center bg-white px-12 py-10 rounded-2xl'>
                    <img className='w-15' src={successReview} alt="" />
                    <CountUp className='text-[64px] font-extrabold' start={1200} end={1900} suffix='+' duration={4} enableScrollSpy={true} scrollSpyDelay={500} />
                    <p className='text-2xl font-semibold'>Patients</p>
                </div>
                <div className='flex flex-col items-center bg-white px-12 py-10 rounded-2xl'>
                    <img className='w-15' src={successStaffs} alt="" />
                    <CountUp className='text-[64px] font-extrabold' start={0} end={300} suffix='+' duration={4} enableScrollSpy={true} scrollSpyDelay={500} />
