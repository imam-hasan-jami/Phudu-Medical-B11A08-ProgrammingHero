...
const DoctorCard = ({ doctor }) => {
    const { doctor_image, name, experience, education, unique_registration_number, availability } = doctor || {};
            ...
            <div className="card bg-base-100 w-full shadow-sm rounded-2xl">
                ...
                <div className="px-10 pt-4">
                    <div className='flex items-center justify-center gap-2 mb-4'>
                        {/* doctor's availability. if the doctor is available it will say "Available" if not, it will say "Not Available" */}
                    ...
                    <p className='text-[18px] font-medium text-center text-[#0F0F0FB3]/70'>{education}</p>
                    <hr className="w-full mx-auto border-t border-dashed border-gray-300 my-4" />
